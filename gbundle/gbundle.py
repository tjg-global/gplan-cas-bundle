...
def command_line():
    ...
    parser.add_argument("--from-commit", help="A SHA representing the first commit to be used. Default: the last commit will be picked up from the database if available; otherwise the first commit to master/main")
    parser.add_argument("--to-commit", help="A SHA representing the last commit to be used. Default: the last commit to master/main")
